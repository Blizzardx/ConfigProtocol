...
const codeTemplate_GoList = `// Generated by gen-tool
// DO NOT EDIT!
package {{.PackageName}}
...
`
const codeTemplate_GoMap = `// Generated by gen-tool
// DO NOT EDIT!
package {{.PackageName}}
...
type {{.ConfigName}} struct {
	Content map[{{.MapKeyType}}]*{{.ConfigName}}Info
}
type {{.ConfigName}}Info struct {
{{range .FieldList}}
	{{.Name}} {{.Type}}
...
func (self *genRuntimeCodeTool_Go) GenRuntimeCode(outputPath string, provision *ConfigDefine, enumInfo []*EnumDefine) error {
	...
	if isUsedTimePkg {
		provision.ImportPkg = append(provision.ImportPkg, "time")
	}
	if isUsedColorPkg {
		provision.ImportPkg = append(provision.ImportPkg, "image/color")
	}
	...
	if provision.MapKeyType != "" {
		...
		content, err = generateCode(codeTemplate_GoMap, provision, true)
		if err != nil {
			return err
		}
	} else {
		content, err = generateCode(codeTemplate_GoList, provision, true)
		if err != nil {
			return err
		}
	}
